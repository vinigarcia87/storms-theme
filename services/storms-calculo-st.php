...
add_action( 'wp_enqueue_scripts', 'storms_checkout_enqueue_scripts' );
 ...
 * @param int $order_id
 */
function storms_add_order_fee_meta( $item_id, $item, $order_id ) {
	/** @var wpdb $wpdb */
	global $wpdb;
...
add_action( 'woocommerce_new_order_item', 'storms_add_order_fee_meta', 10, 3 );
