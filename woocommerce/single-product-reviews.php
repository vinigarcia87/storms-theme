		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
                    ...
                    add_filter( 'storms_wc_product_review_comment_form_args', function( $args ) {

                        if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
                            $textarea = $args['comment_field'];
                            $args['comment_field'] = '<div class="comment-form-rating"><label for="rating">' . esc_html__( 'Your rating', 'woocommerce' ) . '</label><select name="rating" id="rating" aria-required="true" required>
                                <option value="">' . esc_html__( 'Rate&hellip;', 'woocommerce' ) . '</option>
                                <option value="5">' . esc_html__( 'Perfect', 'woocommerce' ) . '</option>
                                <option value="4">' . esc_html__( 'Good', 'woocommerce' ) . '</option>
                                <option value="3">' . esc_html__( 'Average', 'woocommerce' ) . '</option>
                            ...
                            $args['comment_field'] = $args['comment_field'] . $textarea;
                        }
