...
<table
	...
	<tr>
		...
		<th class="product-name" colspan="2">
			<span class="nobr">
				<?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Nome do Produto', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?>
			</span>
		</th>
		...
		<?php if ( $show_quantity ) : ?>
			...
			<th class="product-quantity">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_quantity_heading', __( 'Quantidade', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<td class="product-name">
						...
						if ( $show_dateadded && $item->get_date_added() ) :
							...
							echo '<span class="dateadded">' . esc_html( sprintf( __( 'Adicionado em: %s', 'yith-woocommerce-wishlist' ), $item->get_date_added_formatted() ) ) . '</span>';
						endif;
						?>
					</td>
